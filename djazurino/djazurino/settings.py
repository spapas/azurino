"""
Django settings for djazurino project.
...
SECRET_KEY = "django-insecure-sm#l!7%hau!-x*p(1vt(66^h^i9++4^d!#m30y%641tfz(6_$+"
...
WSGI_APPLICATION = "djazurino.wsgi.application"
...
STORAGES = {
    "default": {
        "BACKEND": "djazurino.storages.AzureBlobStorage",
    },
    "staticfiles": {
