defmodule AzurinoWeb.UserAuthTest do
  use AzurinoWeb.ConnCase

  alias Azurino.Accounts
  alias Azurino.Accounts.Scope
  alias AzurinoWeb.UserAuth

  import Azurino.AccountsFixtures

  @remember_me_cookie "_azurino_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AzurinoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
